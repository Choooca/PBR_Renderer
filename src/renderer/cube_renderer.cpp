...
CubeRenderer::CubeRenderer(const glm::vec3& position) : ShapeRenderer(position){}

void CubeRenderer::InitVariables(std::string texture_path )  {
...
void CubeRenderer::Render(const std::unique_ptr<Camera>& cam) {
	m_shader->use();
